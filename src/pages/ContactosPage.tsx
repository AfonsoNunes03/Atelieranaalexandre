          ...
          <FadeIn>
            ...
            <div className="flex gap-3">
              {([
                ...
                <a key={label} href={label === "Instagram" ? "https://www.instagram.com/margaridajalexandre" : "mailto:atelier.anaalexandre@gmail.com"} aria-label={label}
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between md:gap-8">
            ...
            <FadeIn direction="none" delay={0.1}>
              <div className="flex items-center gap-3">
                <a href="https://www.instagram.com/margaridajalexandre" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
